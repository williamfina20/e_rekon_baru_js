        ...
        axios.put(`${urlWeb}/api/bandara/datarekon/${data_rekon.id}/update`, {
            ...
            .then((res) => {
                ...
                if (res.data.pesan === 'gagal') {
                    ...
                    setTimeout(() => {
                        window.location.replace(`/bandara_staf/datarekon/${data_rekon.maskapai_id}/show`);
                    }, 600);
                }
            })
    ...
    return (
        <div>
            ...
            <form onSubmit={simpanData}>
                ...
                <div className="mb-3">
                    <a href={`/bandara_staf/datarekon/${data_rekon.maskapai_id}/show`}
...
export default BandaraStafRekonEdit

if (document.getElementById('bandara_staf_rekon_edit')) {
    const domNode = document.getElementById('bandara_staf_rekon_edit');
    const root = createRoot(domNode);
    root.render(<BandaraStafRekonEdit data_rekon={window.data_rekon} data_maskapai={window.data_maskapai} />);
}