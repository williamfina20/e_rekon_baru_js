    ...
    <div class="mx-4">
        <div class="row">
            ...
            <div class="col-4 text-end">
                <a href="{{ route('admin.datarekon.show', $data_rekon->maskapai_id) }}"
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{-- ============================================ --}}
                    <div>
                        @if ($data_rekon->admin_status == 1)
                            <form action="{{ route('admin.datarekon.persetujuan', $data_rekon->id) }}" method="post">
                                @csrf
                                @method('put')
