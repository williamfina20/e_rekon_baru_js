...
<head>
    ...
    <title>Bandara Staf E-rekon</title>
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-light waves-effect waves-dark pro-pic"
                                ...
                                <div class=" ms-1 fs-5">Bandara Staf - {{ Auth::user()->name }}</div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated pt-2"
                                aria-labelledby="navbarDropdown">
                                <a href="{{ route('bandara_staf.profil') }}" class="dropdown-item text-center">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('bandara_staf.beranda') }}" aria-expanded="false"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu">Beranda</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('bandara_staf.datarekon') }}" aria-expanded="false"><i
