...
<head>
    ...
    <title>Maskapai Pusat E-rekon</title>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-light" style="background-color: #D4E2D4">
                ...
                <div class="navbar-collapse collapse shadow-sm" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-dark waves-effect waves-dark pro-pic" href="#"
                                id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="ti-user m-r-5 m-l-5"></i>
                                <div class=" ms-1 fs-5">Maskapai Pusat - {{ Auth::user()->name }}</div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated pt-2"
                                aria-labelledby="navbarDropdown">
                                <a href="{{ route('maskapai_pusat.profil') }}" class="dropdown-item text-center">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('maskapai_pusat.beranda') }}" aria-expanded="false"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu">Beranda</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('maskapai_pusat.datamaskapai') }}" aria-expanded="false"><i
                                    class="mdi mdi-airplane"></i><span class="hide-menu">Data Maskapai</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('maskapai_pusat.datarekon') }}" aria-expanded="false"><i
