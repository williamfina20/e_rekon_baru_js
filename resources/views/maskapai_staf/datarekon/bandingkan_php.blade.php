                                    ...
                                    @if (!in_array($b_item['AWB'], $tampung_kunci))
                                        <tr class="text-info">
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <form
                                                    action="{{ route('maskapai_staf.datarekon.bandingkan_tambah', $data_rekon->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                    ...
                                    @if ($a_validasi_awb_tidak_ada[$a_items] == 'tidak')
                                        <tr class="text-danger">
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <form
                                                    action="{{ route('maskapai_staf.datarekon.bandingkan_hapus', $data_rekon->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('maskapai_staf.datarekon.bandingkan_edit', $data_rekon->id) }}" method="post">
                    @csrf
                    @method('put')
