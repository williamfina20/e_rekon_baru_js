        ...
        axios.put(`${urlWeb}/api/maskapai/datarekon/${data_rekon.id}/update`, {
            ...
            .then((res) => {
                ...
                if (res.data.pesan === 'gagal') {
                    ...
                    setTimeout(() => {
                        window.location.replace(`/maskapai_staf/datarekon`);
                    }, 600);
                }
            })
    ...
    return (
        <div>
            ...
            <form onSubmit={simpanData}>
                ...
                <div className="mb-3">
                    <a href={`/maskapai_staf/datarekon`}
...
export default MaskapaiStafRekonEdit

if (document.querySelector('#maskapai_staf_rekon_edit')) {
    const domNode = document.querySelector('#maskapai_staf_rekon_edit');
    const root = createRoot(domNode);
    root.render(<MaskapaiStafRekonEdit data_rekon={window.data_rekon} data_maskapai={window.data_maskapai} />);
}