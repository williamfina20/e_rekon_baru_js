                ...
                <div class="card">
                    <div class="card-body">
                        <table class="mb-3">
                            ...
                            <tr>
                                <td>Bandara</td>
                                <td>: {{ Auth::user()->maskapai->bandara->user->name }}</td>
                            </tr>
                            <tr>
                                <td>Nama Pimpinan</td>
                                <td>: {{ Auth::user()->maskapai->nama_pimpinan }}</td>
                            </tr>
                            <tr>
                                <td>Jabatan Pimpinan</td>
                                <td>: {{ Auth::user()->maskapai->jabatan_pimpinan }}</td>
                            </tr>
                        </table>
                        <form action="{{ route('maskapai.profil_update') }}" method="post">
                            @csrf
                            <div class="mb-3">
