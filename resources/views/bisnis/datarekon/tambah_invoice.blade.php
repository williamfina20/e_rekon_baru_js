...
@section('content')
    <div class="mx-4 d-flex justify-content-between">
        <div>
            <h1 class="mb-0 fw-bold">Tambah Invoice</h1>
            <h3>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{ route('bisnis.datarekon.simpan_invoice', $data_rekon->id) }}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label>Tipe Invoice</label>
                                <select name="tipe_invoice" class="form-control" required>
                                    <option value="">-- Pilih --</option>
                                    <option value="one_invoice">one invoice</option>
